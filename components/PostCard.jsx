...
const PostCard = ({ post }) => {
  return (
    <div className=" mb-5 w-full rounded-lg bg-white p-0 pb-10 shadow-lg">
      ...
      <h1 className="mb-5 cursor-pointer px-4 text-center text-xl font-bold uppercase leading-7 transition duration-700 hover:text-yellow-600 md:px-10">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="inline-block transform cursor-pointer rounded-full bg-black px-8 py-2 font-medium text-white transition duration-500 hover:-translate-y-1">
            Continue Reading
          </span>
        </Link>
      </div>
